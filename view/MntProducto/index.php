...
<html lang="en">
  <head>
    ...
    <link href=".../../public/lib/css/ionicons.css" rel="stylesheet">
    <link href="../../public/libt-scrollbar/css/perfect-scrollbar.css" rel="stylesheet">
  ...
  <body>
    ...
    <div class="br-mainpanel">
      ...
      <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
        <h4 class="tx-gray-800 mg-b-5">Paginas de productos</h4>
        <p class="mg-b-0">Aquí voy a configurar mi pagina de productos.</p>
      </div>
    ...
    <script src="../../public/libpopper.js/popper.js"></script>
